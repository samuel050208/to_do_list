...
class load_window:
    def __init__(self, addButton_callback, clearButton_callback, remButton_callback, exit_callback):
        ...
        self.actionmenu.add_command(label = "New list", command = clearButton_callback)
        self.actionmenu.add_command(label="Exit", command = exit_callback)
...
class load_window:
    ...
    def activate_buttons(self):
        for i in range(10):
>>>>>>> 32bc70a71efa48a75d26755055040951bd118b97
